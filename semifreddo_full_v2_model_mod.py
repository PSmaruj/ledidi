...
class Semifreddo():
    ...
    def forward(self):    
        ...
        # Replace ±5 bins, 11 bins total - 3 bins replaced
        x[:, :, edited_slice_0_start-1 : edited_slice_0_end+2] = sub_x_0[:, :, 4:7]
        
        # Replace ±5 bins, 11 bins total - 1 bins replaced
        # x[:, :, edited_slice_0_start : edited_slice_0_end+1] = sub_x_0[:, :, 5:6]
