...
class Ledidi(torch.nn.Module):
    ...
    def __init__(self, 
        ...
        temp_output0, temp_output1, temp_output2, temp_output3 = semifreddo_temp_output_path_list
    ...
    def fit_transform(self, X, y_bar, X1=None):
        ...
        if self.output_mask_path is not None:
            ...
            y_hat_unmasked = y_hat_unmasked.to(device=y_bar_unmasked.device)
        ...
        for i in range(1, self.max_iter+1):  
            ...
            if total_loss < best_total_loss:
                ...
                y_bar_flat = y_bar_flat.to(y_hat_flat.device)       
